            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="roomSettingsModalLabel">
                            Settings
                        </h5>
                    ...
                    <div className="modal-body">
                        <div className="row">
                            <label className="col-10" for="option1">
                                When your question is anwsered
                            </label>
                            <input type="checkbox" className="col-2" id="option1" />
                            <label className="col-10 py-1" for="option2">
                                When a new question is posted
                            </label>
                            <input type="checkbox" className="col-2" id="option2" />
                            <label className="col-10" for="option3">
